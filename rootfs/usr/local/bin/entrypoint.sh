...
# @@File             :  entrypoint.sh
# @@Description      :  entrypoint point for readme-to-dockerhub
...
__heath_check() {
  ...
  start-readme-to-dockerhub.sh healthcheck || status=$((status + 1))
...
HOSTNAME="${HOSTNAME:-casjaysdev-readme-to-dockerhub}"
